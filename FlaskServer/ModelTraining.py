...
class ModelTrainer:
    ...
    def Auto_Run_Model(self, model_params):
                                ...
                                for n_past in n_pasts:
                                    for n_epoch in n_epochs:
                                        for layer in layers:
                                            ...
                                            model, test_Acc, history = self.Auto_Run_Model(
                                                prms)
                                            if test_Acc != None:
    ...
    def main(self, user, path, try_num, threshold):
        #global merged_df
...
if __name__ == '__main__':
    ...
    user = 'alon'
    mt.main(user=user, path=path, try_num=try_num, threshold=threshold)
